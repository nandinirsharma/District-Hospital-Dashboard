                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <button id="register-doctors" class="form-control form-control-sm" style="background:powderblue;margin-left: 20px;">Register Doctors</button>
                                                    <button id="manage-doctors" class="form-control form-control-sm" style="background:powderblue;margin-left: 20px;">Manage Doctors</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Doctor Phone</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT doc_name,doc_dept,doc_number,doc_status FROM  doc_name where doc_status= 'ACTIVE'"; 
