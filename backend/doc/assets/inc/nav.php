<?php
    ...
    $ret="SELECT * FROM  admin_details WHERE admin_id = ? AND admin_email = ?";
    $stmt= $mysqli->prepare($ret) ;
    $stmt->bind_param('is',$admin_id, $admin_email);
    $stmt->execute() ;//ok
    $res=$stmt->get_result();
    //$cnt=1;
    ...
    <div class="navbar-custom">
        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                <span class="logo-lg" alt="" height="18" style="margin-right:20px; background-color: white;">
                <a href="#" class="logo">
                    <i class="fas fa-hands"></i> HealthCare</a>
