                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">HealthCare Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                     ...
                                                     */ 
                                                    $result ="SELECT count(*) FROM doc_name";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Doctors Working</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $assets;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Wards</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $patient;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Beds</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Staff</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM patients ORDER BY RAND() LIMIT 5 "; 
